...
# cairowidget
This code illustrates one possible way to use cairo in your FLTK project. It does not require support for cairo or SVG to be compiled into FLTK and shows an alternative way to render SVG using cairo and NanoSVG.
